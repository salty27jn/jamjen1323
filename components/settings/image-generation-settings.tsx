...
import { AlertCircle, Camera, ChevronDown, Image, ImageOff, Info, Plus, RefreshCw, Sparkles, Trash2, Upload } from "lucide-react";
            ...
            <div className="menu-group">
                ...
                <div className="menu-item">
                    ...
                    <span className="settings-tools-menu-copy">
                        ...
                        <span className="menu-desc settings-tools-menu-desc">聊天与朋友圈中不再出现照片标签以及图片描述文字。</span>
                    </span>
                    <span className="menu-right settings-tools-menu-toggle">
